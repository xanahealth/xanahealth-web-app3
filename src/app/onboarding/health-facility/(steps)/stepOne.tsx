...
export const StepOne = ({ formData, setFormData, nextStep }: any) => {
  ...
  const handleStepOneSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (facilityName.value === "") {
      setValidationErrors((prevState: any) => ({
        ...prevState,
        [facilityName.id]: "Facility name is required",
      }));
    } else if (facilityEmail.value === "") {
      setValidationErrors((prevState: any) => ({
        ...prevState,
        [facilityEmail.id]: "Facility email is required",
      }));
    } else if (
      facilityPhone.value === "" ||
      ...
      setValidationErrors((prevState: any) => ({
        ...prevState,
        [facilityPhone.id]: "Facility phone is required",
      }));
    } else {
      nextStep();
    }
            ...
            <div>
              <Select onValueChange={handleSelectChange}>
                <Label htmlFor="type" className="mb-2">
                  Health Facility type <span className="text-red-500">*</span>
                </Label>
